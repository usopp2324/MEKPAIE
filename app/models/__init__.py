...
class Employee(Base):
    ...
    salary_premium_per_day = Column(Float, default=8.0)
    wage_premium_per_day = Column(Float, default=22.8)
    transport_premium_per_day = Column(Float, default=19.0)
    leave_balance = Column(Float, default=0.0)
    leave_balance_year = Column(Integer, default=datetime.utcnow().year)
    leave_balance_month = Column(Integer, default=datetime.utcnow().month)
...
class Payroll(Base):
    ...
    absence_days = Column(Float, default=0.0)
